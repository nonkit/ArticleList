# Get-TechNetWikiArticleList.ps1 - Get Article List from Microsoft TechNet Wiki
# Version 0.0.1
# Copyright © 2022 Nonki Takahashi.  The MIT License.

# Usage:
# .\Get-TechNetWikiArticleList [SmallBasic | WikiNinjasBlog | AzureDevCommunityBlog [yyyy [q [yyyy [q]]]]]

# History:
#  0.0.1 2022-04-17 Created from Get-TechCommunityArticleList.
